        ...
        <div className="container">
          <div className="page-header__row page-header__row--sb">
            <div className="page-header__logo">
              ...
              <a className="logo">
                <svg className="logo-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="page-header__info">
              <div className="d-xl-block">
                <div className="page-header__compare">
                  <div className="phone page-header__phone">
                    <a className="phone__wrap phone__wrap--pd phone__wrap--arrow" href="tel:+7(347)246–22–58">
